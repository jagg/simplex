...
copy %EX_LIBS%\SDL2_mixer-2.0.4\lib\x64\* . >nul

set EX_INCLUDES= /I%EX_LIBS%\SDL2-2.0.14\include ^
                 /I%EX_LIBS%\SDL2_image-2.0.5\include ^
                 /I%EX_LIBS%\SDL2_ttf-2.0.15\include ^
                 /I%EX_LIBS%\SDL2_mixer-2.0.4\include
                 
set LIBS=SDL2.lib SDL2main.lib Shell32.lib SDL2_image.lib SDL2_ttf.lib SDL2_mixer.lib
